...
DEFAULT_SEARCH_SPACE = {
    ...
    "assign.use_layer_weights": {"type": "categorical", "choices": [True, False]},
...
BEST_KNOWN_PARAMS = {
    "assign.foreground_prob_power": 1.0,
    "assign.normalize_over_queries": True,
    "assign.similarity_floor": 0.0,
    "assign.use_alpha_focal": True,
    "assign.use_foreground_prob": False,
    "assign.use_all_queries": True,
    "assign.use_layer_weights": True,
    "assign.use_query_quality": True,
    "assign.query_quality_power": 0.6,
    "cluster.graph_affinity_threshold": 0.76,
    "cluster.cluster_per_class": True,
    "cluster.dbscan_min_samples": 1,
    "cluster.dbscan_use_sample_weight": True,
    "cluster.method": "cc",
    "cluster.promote_noise_to_singletons": True,
    "overlap.assignment_strength_power": 0.5,
    ...
    "overlap.use_assignment_strength": True,
    "overlap.use_class_confidence": True,
    "overlap.use_foreground_confidence": True,
    "seed.exclude_background": True,
    "seed.foreground_score_power": 1.0,
    "seed.max_influence": None,
    "seed.min_num_seeds": 1,
    "seed.min_foreground_prob": 0.22,
    "seed.topk": None,
    "seed.quality_threshold": 0.17,
    "seed.use_foreground_in_score": False,
}
